      ...
      {state === "idle" && (
        <Card className="border-dashed">
          <CardContent className="p-0">
            <label className="flex flex-col items-center justify-center w-full h-72 cursor-pointer hover:bg-primary/[0.03] transition-colors rounded-2xl">
              <div className="relative mb-6">
                <svg width="56" height="56" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="opacity-40">
                  <rect x="8" y="6" width="32" height="2" rx="1" fill="#7A2B3A"/>
                  <rect x="12" y="12" width="4" height="28" rx="1" fill="#D4D4CE"/>
                  <rect x="22" y="12" width="4" height="28" rx="1" fill="#D4D4CE"/>
                  <rect x="32" y="12" width="4" height="28" rx="1" fill="#D4D4CE"/>
                  <rect x="8" y="42" width="32" height="2" rx="1" fill="#7A2B3A"/>
                  <rect x="6" y="24" width="36" height="1.5" rx="0.75" fill="#7A2B3A" opacity="0.8"/>
                </svg>
              </div>
              <span style={{ fontFamily: "var(--font-display)" }} className="text-xl font-light text-white">Place card in frame</span>
              <span className="text-sm text-muted-foreground mt-2">Photograph front. Back optional but recommended.</span>
              ...
              <input ref={fileInputRef} type="file" className="hidden" accept="image/*" capture="environment" onChange={handleFileSelect} />
            </label>
          </CardContent>
        </Card>
      )}
